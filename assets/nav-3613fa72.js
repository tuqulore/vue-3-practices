...
</div>`,frontmatter:{},index:67,start:1929,end:1974,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:67,no:68},__clicksElements:[],__preloaded:!1}},{path:"69",name:"page-69",component:jE,meta:{slide:{raw:`
# Vue + Vue Router と Nuxt 3 の比較（データ取得）
...
\`\`\``,frontmatter:{},index:68,start:1975,end:2002,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:68,no:69},__clicksElements:[],__preloaded:!1}},{path:"70",name:"page-70",component:JE,meta:{slide:{raw:`
# Vue + Vue Router と Nuxt 3 の比較（データ取得）
...
場合によっては（$fetch ではなく） fetch を使うことも検討すること`,frontmatter:{},index:69,start:2003,end:2016,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:69,no:70},__clicksElements:[],__preloaded:!1}},{path:"71",name:"page-71",component:s2,meta:{slide:{raw:`
# スタイルガイド
...
[スタイルガイド](https://v3.ja.vuejs.org/style-guide/)`,frontmatter:{},index:70,start:2017,end:2028,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:70,no:71},__clicksElements:[],__preloaded:!1}},{path:"72",name:"page-72",component:u2,meta:{slide:{raw:`
...
自信がない箇所は復習・質問しましょう！`,frontmatter:{},index:71,start:2029,end:2051,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:71,no:72},__clicksElements:[],__preloaded:!1}},{path:"73",name:"page-73",component:h2,meta:{slide:{raw:`
# 課題
...
- レベル 1 ～ 3 の 3 つある
- 1 から順番に取り組んでもらう
- 16 時に解説する`,frontmatter:{},index:72,start:2052,end:2059,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:72,no:73},__clicksElements:[],__preloaded:!1}},{path:"74",name:"page-74",component:_2,meta:{slide:{raw:`
# 課題（レベル 1）
...
1. useFetch を使って http://localhost:3000/data.json から果物のリストを取得してください
2. 果物を順序なしリストで表示してください https://developer.mozilla.org/ja/docs/Web/HTML/Element/ul`,frontmatter:{},index:73,start:2060,end:2068,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:73,no:74},__clicksElements:[],__preloaded:!1}},{path:"75",name:"page-75",component:F2,meta:{slide:{raw:`
# 課題（レベル 2）
...
コード上のコメントを読みながら、未完成のアプリを完成させてください`,frontmatter:{},index:74,start:2069,end:2076,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:74,no:75},__clicksElements:[],__preloaded:!1}},{path:"76",name:"page-76",component:$2,meta:{slide:{raw:`
# 課題（レベル 3）
...
コード上のコメントを読みながら、未完成のアプリを完成させてください`,frontmatter:{},index:75,start:2077,end:2084,notesHTML:"",filepath:"/home/runner/work/vue-3-practices/vue-3-practices/docs/slides.md",id:75,no:76},__clicksElements:[],__preloaded:!1}},{path:"77",component:ZB,meta:{layout:"end"}}],qs=S2,P2=[{name:"play",path:"/",component:Bv,children:[...qs]},{name:"print",path:"/print",component:KB},{path:"",redirect:{path:"/1"}},{path:"/:pathMatch(.*)",redirect:{path:"/1"}},{path:"/presenter/print",component:()=>Ul(()=>import("./PresenterPrint-bb383497.js"),["assets/PresenterPrint-bb383497.js","assets/NoteViewer-4c652ee2.js","assets/index-a2d28d55.js"])},{name:"presenter",path:"/presenter/:no",component:()=>Ul(()=>import("./Presenter-13c7b36d.js"),["assets/Presenter-13c7b36d.js","assets/NoteViewer-4c652ee2.js","assets/DrawingControls-86c3b56e.js","assets/index-a2d28d55.js","assets/Presenter-214154c4.css"]),beforeEnter:e=>{if(!Sn.remote||Sn.remote===e.query.password)return!0;if(Sn.remote&&e.query.password===void 0){const l=prompt("Enter password");if(Sn.remote===l)return!0}return e.params.no?{path:`/${e.params.no}`}:{path:""}}},{path:"/presenter",redirect:{path:"/presenter/1"}}],Bl=Zf({history:J5("/vue-3-practices"),routes:P2});function V2(e,l,{mode:n="replace"}={}){return O({get(){const t=Bl.currentRoute.value.query[e];return t==null?l??null:Array.isArray(t)?t.filter(Boolean):t},set(t){Se(()=>{Bl[C(n)]({query:{...Bl.currentRoute.value.query,[e]:t}})})}})}const Vi=ns(0);Se(()=>{Bl.afterEach(async()=>{await Se(),Vi.value+=1})});const Ue=O(()=>Bl.currentRoute.value),La=O(()=>Ue.value.query.print!==void 0),O2=O(()=>Ue.value.query.print==="clicks"),Ye=O(()=>Ue.value.query.embedded!==void 0),Xe=O(()=>Ue.value.path.startsWith("/presenter")),Oi=O(()=>La.value&&!O2.value),Xt=O(()=>Ue.value.query.password),L2=O(()=>!Xe.value&&(!Ls.remote||Xt.value===Ls.remote)),gc=V2("clicks","0"),Li=O(()=>qs.length-1),T2=O(()=>Ue.value.path),Ys=O(()=>parseInt(T2.value.split(/\//g).slice(-1)[0])||1);O(()=>Ta(Ys.value));const ve=O(()=>qs.find(e=>e.path===`${Ys.value}`));O(()=>{var e,l,n;return(n=(l=(e=ve.value)==null?void 0:e.meta)==null?void 0:l.slide)==null?void 0:n.id});O(()=>{var e,l;return((l=(e=ve.value)==null?void 0:e.meta)==null?void 0:l.layout)||(Ys.value===1?"cover":"default")});const Bt=O(()=>qs.find(e=>e.path===`${Math.min(qs.length,Ys.value+1)}`)),M2=O(()=>{var e,l;return Vi.value,((l=(e=ve.value)==null?void 0:e.meta)==null?void 0:l.__clicksElements)||[]}),ql=O({get(){if(Oi.value)return 99999;let e=+(gc.value||0);return isNaN(e)&&(e=0),e},set(e){gc.value=e.toString()}}),To=O(()=>{var e,l;return+(((l=(e=ve.value)==null?void 0:e.meta)==null?void 0:l.clicks)??M2.value.length)}),N2=O(()=>Ys.value<qs.length-1||ql.value<To.value),R2=O(()=>Ys.value>1||ql.value>0),I2=O(()=>qs.filter(e=>{var l,n;return(n=(l=e.meta)==null?void 0:l.slide)==null?void 0:n.title}).reduce((e,l)=>(Ma(e,l),e),[])),j2=O(()=>Na(I2.value,ve.value));O(()=>Ra(j2.value));function Il(){To.value<=ql.value?Mo():ql.value+=1}async function jl(){ql.value<=0?await No():ql.value-=1}function Ta(e){return Xe.value?`/presenter/${e}`:`/${e}`}function Mo(){const e=Math.min(qs.length,Ys.value+1);return hn(e)}async function No(e=!0){const l=Math.max(1,Ys.value-1);await hn(l),e&&To.value&&Bl.replace({query:{...Ue.value.query,clicks:To.value}})}function hn(e,l){return Bl.push({path:Ta(e),query:{...Ue.value.query,clicks:l}})}function H2(e){const l=ns(0),{direction:n,distanceX:t,distanceY:a}=y5(e,{onSwipeStart(r){r.pointerType==="touch"&&(Zn.value||(l.value=Nt()))},onSwipeEnd(r){if(r.pointerType!=="touch"||!l.value||Zn.value)return;const c=Math.abs(t.value),p=Math.abs(a.value);c/window.innerWidth>.3||c>100?n.value===Qe.LEFT?Il():jl():(p/window.innerHeight>.4||p>200)&&(n.value===Qe.DOWN?No():Mo())}})}async function Dc(){const{saveAs:e}=await Ul(()=>import("./FileSaver.min-17c85779.js").then(l=>l.F),[]);e(Ip(Ls.download)?Ls.download:Ls.exportFilename?`${Ls.exportFilename}.pdf`:"/vue-3-practicesslidev-exported.pdf",`${Ls.title}.pdf`)}async function f6(e){var l,n;if(e==null){const t=(n=(l=ve.value)==null?void 0:l.meta)==null?void 0:n.slide;if(!(t!=null&&t.filepath))return!1;e=`${t.filepath}:${t.start}`}return await fetch(`/__open-in-editor?file=${encodeURIComponent(e)}`),!0}function Ma(e,l,n=1){var a,r,c,p,i;const t=(r=(a=l.meta)==null?void 0:a.slide)==null?void 0:r.level;t&&t>n&&e.length>0?Ma(e[e.length-1].children,l,n+1):e.push({children:[],level:n,path:l.path,hideInToc:Boolean((c=l.meta)==null?void 0:c.hideInToc),title:(i=(p=l.meta)==null?void 0:p.slide)==null?void 0:i.title})}function Na(e,l,n=!1,t){return e.map(a=>{const r={...a,active:a.path===(l==null?void 0:l.path),hasActiveParent:n};return r.children.length>0&&(r.children=Na(r.children,l,r.active||r.hasActiveParent,r)),t&&(r.active||r.activeParent)&&(t.activeParent=!0),r})}function Ra(e,l=1){return e.filter(n=>!n.hideInToc).map(n=>({...n,children:Ra(n.children,l+1)}))}export{G2 as $,ns as A,t6 as B,o6 as C,bs as D,c6 as E,ks as F,Ne as G,a6 as H,Qi as I,Xi as J,Zo as K,Se as L,yp as M,G as N,Wl as O,ca as P,Cl as Q,z2 as R,Oi as S,q2 as T,Hy as U,zy as V,Tp as W,Lp as X,Op as Y,Ry as Z,P as _,n6 as a,ze as a$,Q2 as a0,X2 as a1,Y2 as a2,Z2 as a3,MB as a4,NB as a5,Dc as a6,Il as a7,Mo as a8,f6 as a9,Di as aA,re as aB,lm as aC,W2 as aD,U2 as aE,To as aF,N2 as aG,Bt as aH,ut as aI,Zn as aJ,mt as aK,mv as aL,$a as aM,Sa as aN,uv as aO,fm as aP,Ve as aQ,r6 as aR,nl as aS,xn as aT,Pl as aU,Ie as aV,Zt as aW,$h as aX,Sh as aY,Ph as aZ,Oh as a_,jl as aa,No as ab,Ue as ac,J2 as ad,mn as ae,Fs as af,i6 as ag,O8 as ah,s as ai,Js as aj,eo as ak,Xs as al,qs as am,Li as an,o as ao,gs as ap,Ea as aq,js as ar,u6 as as,ve as at,L as au,zh as av,H2 as aw,p6 as ax,y6 as ay,g as az,Ys as b,Vp as b0,d6 as b1,ie as b2,yo as b3,Ym as b4,Mp as b5,Lh as b6,Ls as c,ql as d,Xe as e,Ns as f,Ta as g,b as h,s6 as i,S as j,_u as k,Z as l,F as m,A as n,e6 as o,l6 as p,se as q,Bl as r,et as s,O as t,K2 as u,yr as v,Is as w,up as x,C as y,Hi as z};
